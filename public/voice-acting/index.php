    ...
    <body class="font-sans antialiased">
        <div id="app" class="min-h-screen bg-stone-400">
            <div class="max-w-7xl mx-auto pt-24">
                <div class="bg-white p-6 rounded shadow-lg items-center justify-center flex">
                    <p class="text-xl">You can reach me on <a class="text-link" href="https://www.acx.com/narrator?p=A2IHHXGQH9NOY5" title="ACX profile for Brian Rogers">ACX</a> or <a class="text-link" href="https://cstng.cc/captbrogers" title="Casting Call: Brian Rogers">Casting Call Club</a></p>
                </div>
